          ...
          <div className="grid md:grid-cols-2 gap-12 mb-16">
            <Card className="border-0 card-shadow rounded-2xl">
              <CardContent className="p-8">
                ...
                <p className="text-gray-600 leading-relaxed">
                  To provide accessible, high-quality educational programs that nurture individual talents, 
                  foster critical thinking, and prepare learners for success in an ever-evolving world.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 card-shadow rounded-2xl">
              <CardContent className="p-8">
                ...
                <p className="text-gray-600 leading-relaxed">
                  To be the leading platform for personalized learning, creating a global community 
                  where every individual can discover their potential and achieve their dreams.
                </p>
              </CardContent>
            </Card>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            ...
            <Card className="border-0 card-shadow rounded-2xl text-center">
              <CardContent className="p-8">
                ...
                <p className="text-gray-600">info@kikislearninghub.com</p>
              </CardContent>
            </Card>
          </div>
        </div>
