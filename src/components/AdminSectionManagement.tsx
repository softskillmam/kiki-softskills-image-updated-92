  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Manage course sections and their content with drag-and-drop functionality
        </CardDescription>
      </CardHeader>
                              ...
                              <div className="space-y-4">
                                ...
                                <div>
                                  <Label htmlFor="content-url">
                                    {contentForm.type === 'video' ? 'Video URL or Embed Code' : 
                                     contentForm.type === 'link' ? 'External Link URL' : 
                                     contentForm.type === 'document' ? 'Document URL (PDF, PPT, PPTX, DOC, DOCX)' :
                                     'Content URL'}
                                  </Label>
                                  <Textarea
                                    id="content-url"
                                    ...
                                    placeholder={
                                      ...
                                      'YouTube URL, video file URL, or iframe embed code' :
                                      contentForm.type === 'link' ? 'https://example.com' :
                                      contentForm.type === 'document' ? 'https://example.com/document.pdf' :
                                      'URL to your content'
                                    }
                                    rows={contentForm.type === 'video' ? 4 : 2}
                                  />
                                  {contentForm.type === 'video' && (
                                    <div className="text-xs text-gray-500 mt-1">
                                      Supports YouTube URLs, direct video links, or iframe embed codes
                                    </div>
                                  )}
                                  {contentForm.type === 'document' && (
                                    <div className="text-xs text-gray-500 mt-1">
                                      Supports PDF, PPT, PPTX, DOC, DOCX files from any public URL
                                    </div>
                                  )}
                                </div>
                                <div>
